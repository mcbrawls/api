...
import net.mcbrawls.api.db.CaseWhenNoElse.Companion.caseNoElse
...
object LeaderboardTypes : BasicRegistry<LeaderboardType>() {
    ...
    ): Transaction.() -> LeaderboardType.LeaderboardQueryFactory {
        return {
    ...
    private fun createRatio(gameType: LeaderboardGameType, numeratorCauseId: String, denominatorCauseId: String, denominatorMinimum: Long): Transaction.() -> LeaderboardType.LeaderboardQueryFactory {
        return {
            ...
            LeaderboardType.LeaderboardQueryFactory(query, value)
        }
    }
}
